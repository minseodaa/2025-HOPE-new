...
class ScoreCalculator {
  ...
  static double calculateSmileScore({
    ...
    // 가중 평균으로 최종 점수 계산
    final weightedScore = (mouthScore * 0.6) + (eyeScore * 0.3) + (noseScore * 0.1);
  ...
  static double _calculateEyeScore(List<Map<String, double>> eyeCorners) {
    ...
    final rightEyeScore = _calculateSingleEyeScore(eyeCorners.skip(2).take(2).toList());
  ...
  /// 두 점 간의 거리 계산
  static double _calculateDistance(Map<String, double> point1, Map<String, double> point2) {
  ...
  static double calculateScoreChange(double currentScore, double previousScore) {
  ...
  /// Returns: 개선 여부
  static bool isScoreImproved(double currentScore, double previousScore, {double threshold = 0.1}) {
